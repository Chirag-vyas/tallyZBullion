...
const debitcreditInput = document.getElementById("debit-credit");
...
// //billNo. input blocking wrong billNo entries
// billNoInput.addEventListener("input", function () {
//   const OutstandingReceipts = window.api.getOutstandingReceipts();
//   console.log(OutstandingReceipts);
// });
...
btn.addEventListener("click", async (e) => {
  ...
  try {
    await window.api.addReceipts(typeValue, dateValue, nameValue, amountValue);
    ...
    console.log("Error adding receipts: ", error);
  }
});
