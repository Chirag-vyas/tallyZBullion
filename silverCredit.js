...
const tallyZ = async () => {
  ...
  creditEntries.forEach((entry) => {
    ...
    const debitSide = entry.item === "Fine-Silver-Sale";

    const silverEntries =
      entry.item === "Fine-Silver-Purchase" ||
      entry.item === "Fine-Silver-Sale" ||
      entry.item === "Silver-Gat-Purchase";
    ...
    if (nameMatches && dateInRange && silverEntries) {
      const tr = document.createElement("tr");
      tr.className = "text-xl border-b-2 border-gray-300 hover:bg-slate-300";
